...
add wave -noupdate -color Yellow -radix hexadecimal /tb/rst
...
add wave -noupdate -divider SaÃÂÃÂ­das
...
WaveRestoreCursors {{Cursor 1} {7156102200 ps} 0}
...
update
WaveRestoreZoom {3758159300 ps} {10328517900 ps}
